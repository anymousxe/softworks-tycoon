...
// UNDO SYSTEM: Store the state of the PREVIOUS week here
...
auth.onAuthStateChanged(user => {
    ...
    if (user) {
        ...
        document.getElementById('user-email').classList.remove('hidden'); // Show email so we can verify admin
